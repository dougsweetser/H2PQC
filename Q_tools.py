...
class QHStates(QH):
    ...
    def sigma(kind, theta=None, phi=None):
        ...
        sigmas = {}
        sigmas['x'] = QHStates([q0, x_factor, x_factor, q0], "op")
        sigmas['y'] = QHStates([q0, y_factor, y_factor.flip_signs(), q0], "op") 
        sigmas['z'] = QHStates([z_factor, q0, q0, z_factor.flip_signs()], "op")
  
        sigmas['xy'] = sigmas['x'].add(sigmas['y'])
        sigmas['xz'] = sigmas['x'].add(sigmas['z'])
        sigmas['yz'] = sigmas['y'].add(sigmas['z'])
        sigmas['xyz'] = sigmas['x'].add(sigmas['y']).add(sigmas['z'])

        if kind not in sigmas:
            print("Oops, I only know about x, y, z, and their combinations.")
            return None
        
        return sigmas[kind].normalize()
...
i2 = QHStates().identity(2, operator=True)
i2.print_state("i2")
i4 = QHStates().identity(4, operator=True)
...
q_1234 = QHStates([QH([1, 1, 0, 0]), QH([2, 1, 0, 0]), QH([3, 1, 0, 0]), QH([4, 1, 0, 0])])
b = q_1234.bra().Euclidean_product(q_1234)
b.print_state("<b|b>")
QHStates().bracket(q_1234, i4, q_1234).print_state("bracket")
...
class QHaStates(QHa):
    ...
    def sigma(kind, theta=None, phi=None):
        ...
        sigmas = {}
        sigmas['x'] = QHaStates([q0, x_factor, x_factor, q0], "op")
        sigmas['y'] = QHaStates([q0, y_factor, y_factor.flip_signs(), q0], "op") 
        sigmas['z'] = QHaStates([z_factor, q0, q0, z_factor.flip_signs()], "op")
...
class Q8States(Q8):
    ...
    def sigma(kind, theta=None, phi=None):
        ...
        sigmas = {}
        sigmas['x'] = Q8States([q0, x_factor, x_factor, q0], "op")
        sigmas['y'] = Q8States([q0, y_factor, y_factor.flip_signs(), q0], "op") 
        sigmas['z'] = Q8States([z_factor, q0, q0, z_factor.flip_signs()], "op")
...
class Q8aStates(Q8a):
    ...
    def sigma(kind, theta=None, phi=None):
        ...
        sigmas = {}
        sigmas['x'] = Q8aStates([q0, x_factor, x_factor, q0], "op")
        sigmas['y'] = Q8aStates([q0, y_factor, y_factor.flip_signs(), q0], "op") 
        sigmas['z'] = Q8aStates([z_factor, q0, q0, z_factor.flip_signs()], "op")
